...
const publications = [
  ...
  },
  {
    id: "p3",
    type: "Policy Brief",
    title: "Economic Impacts of Pastoralism",
    subtitle: "Policy & Research Brief",
    year: "2025",
    coverImage: "/images/programmes/research-hero.jpg",
    description: "Evidence-based policy brief documenting the economic contributions of pastoralism to Kenya's ASAL counties and national GDP.",
    href: "/resources",
    colour: "from-sage/80",
  },
];
